const SecurityInfo = () => {
  return (
    <div className="container max-w-xl mt-8 justify-center p-10 items-center rounded-3xl bg-[#5D5F81] border border-slate-700 text-slate-300">
      <div className="flex flex-row pb-2 border-b border-slate-300 dark:border-slate-600 mb-2">
        <span className="material-icons mr-1 text-fuchsia-300">
          privacy_tip
        </span>
